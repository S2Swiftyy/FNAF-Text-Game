...
void bonnieDeath()
{
    for(int i = 0; i < 10; i++)
    {
        ...
        else
        {
            ...
            ifstream file("assets/bonnie_scare.txt");
...
void foxyDeath()
{
    for(int i = 0; i < 10; i++)
    {
        ...
        else
        {
            ...
            ifstream file("assets/foxy_scare.txt");
...
void chicaDeath()
{
    for(int i = 0; i < 10; i++)
    {
        ...
        else
        {
            ...
            ifstream file("assets/chica_scare.txt");
...
void checkFoxy()
{
    if(foxyLoc == HIDING)
    {
        ifstream file("assets/stage_1.txt");
    ...
    {
        ifstream file("assets/stage_2.txt");
    ...
    {
        ifstream file("assets/stage_3.txt");
    ...
    {
        ifstream file("assets/stage_4.txt");
...
void loadGame()
{
    ifstream saveFile("save/gameSave.txt");
...
void saveGame()
{
    ofstream saveFile("save/gameSave.txt", ios::trunc);
